...
class Trapzaidol extends Component {
    constructor(props) {
        super(props);
        this.state = {
            A: '',
...
<div className='App'>
                <Layout>
                    <Header style={{background: '#CEB3E5'}}><h1 style={{color:'white'}}>Composite Trapzaidol</h1></Header>
                    <Layout>
                            ...
                            <div style={{ background: '#fff', padding: 24, minHeight: 280 }}>
                                ...
                                <Row>
                                    ...
                                    <Col xs={{ span: 11, offset: 1 }} lg={{ span: 6, offset: 2 }}>
                                        <Button  onClick={() => this.Trapzai()} style={{right:15}}>OK</Button>
                                    </Col>
                                    <Col xs={{ span: 5, offset: 1 }} lg={{ span: 6, offset: 2 }}>
