...
class Newton extends Component {
    ...
    Newtonfx(){
        ...
        const Fxdx = math.derivative(Fx,'x')
        var x=[]
        x[0]= parseFloat(this.state.B)
            let X = {
                x: x[j]
            }
            x[j+1] = x[j]-(Fx1.evaluate(X)/Fxdx.evaluate(X))
    ...
    render() {
        return (
            <div className="App">
                <Layout>
                    <Header style={{background: '#CEB3E5'}}><h1 style={{color:'white'}}>Newton-Raphson</h1></Header>
                    <Layout>
                            ...
                            <h1 style={{ height: '20px' }}></h1>
                                ...
                                <Row>
                                    ...
                                    <Col xs={{ span: 11, offset: 1 }} lg={{ span: 6, offset: 2 }}>
                                        <Button  onClick={() => this.Newtonfx()} style={{right:15}}>OK</Button>
                                    </Col>
                                    <Col xs={{ span: 5, offset: 1 }} lg={{ span: 6, offset: 2 }}>
