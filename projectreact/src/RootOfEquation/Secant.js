...
class Secant extends Component {
    ...
    render() {
        return (
            <div>
                <Layout>
                    <Header style={{background: '#CEB3E5'}}><h1 style={{color:'white'}}>Secant</h1></Header>
                    <Layout>
                        <Content style={{ padding: '0 16px' }}>
                            ...
                            <Card style={{background:'#CEB3E5' ,width:'500px',margin: 'auto'}}>
                                ...
                                <h1 style={{height:'20px'}}></h1>
                                <Input addonBefore="X1" size='large' style={{ width: '400px'}} value={this.state.C} onChange={this.handleX}  />
                                <h1 style={{ height: '20px' }}></h1>
                                <Row>
                                    <Col xs={{ span: 5, offset: 1 }} lg={{ span: 6, offset: 2 }}>
                                    </Col>
                                    <Col xs={{ span: 11, offset: 1 }} lg={{ span: 6, offset: 2 }}>
                                        <Button  onClick={() => this.Secantfx()} style={{right:15}}>OK</Button>
                                    </Col>
                                    <Col xs={{ span: 5, offset: 1 }} lg={{ span: 6, offset: 2 }}>
